...
mvn clean install -pl common-platform-security-center-web
```
...
WORKDIR /app
COPY common-platform-security-center-web/target/*.jar app.jar
EXPOSE 8085
...
Edit `common-platform-security-center-web/src/main/resources/application-local.yml`:
...
- **Documentation**: [docs/](.)
- **Issues**: [GitHub Issues](https://github.com/firefly-oss/common-platform-security-center/issues)
